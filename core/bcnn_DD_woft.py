...
class vgg16:
    ...
    def fc_layers(self):
        ...
        with tf.name_scope('fc-new') as scope:
            ...
            fc3w = tf.get_variable('weights', [512*512, 10], initializer=tf.contrib.layers.xavier_initializer(), trainable=True)
...
if __name__ == '__main__':
    ...
    for epoch in range(8):
        ...
        if epoch==break_training_epoch:
            ...
            np.savez('last_layers_epoch_8.npz',last_layer_weights)
    ...
    for i in range(total_test_batch):
        ...
        correct_pred, y_pred_batch = sess.run([num_correct_preds, y_pred], feed_dict = {imgs: batch_test_x, target: batch_test_y})
    ...
    saver.save(sess, os.getcwd() + "/bcnn_woft")

    with open("class_pred_bcnn.pickle", "wb") as handle:
